...
import java.util.logging.Logger;
    ...
    public FoundDiamondsPluginProperties(FoundDiamonds fd, String file) {
	this.fileName = file;
	this.fd = fd;
	...
	if (file.exists()) {
		...
		load(new FileInputStream(this.fileName));
                ...
                log.log(Level.SEVERE, "[" + fd.getPluginName() + "] Unable to load configuration file!" + this.fileName, ex);
            }
	}
    }
	...
	try {
            ...
            log.log(Level.SEVERE, "[" + fd.getPluginName() + "] Unable to save "+ this.fileName, ex);
	}
    }
